...
import com.todo.cli.database.Database;
import com.todo.cli.helpers.Printer;
import com.todo.cli.cli.Flag;
import com.todo.cli.controllers.StateController;
import com.todo.cli.controllers.TaskController;
...
public class App {
  public static void main(String[] args) {
    ...
    try (Connection dbConnection = DriverManager.getConnection(dbUrl)) {
      ...
      // Task
      flags.put("-l", new Flag(0, (ignored) -> {
        taskController.getAll();;
      }));
      ...
      // State
      flags.put("-lS", new Flag(0, (ignored) -> {
